...
/*
    Screen for the basic FR Test
    ========
    User is displayed a bingo card they must memorize
    Neutral words are displayed one by one
...
class FRScreen extends Component {
    ...
    constructor(props){
        ...
        this.state = { 
                ...
                randSet: [""],
                randomWords: [
                    "burial", "pump", "peanut", "engine", "fashion",
                    "elbow", "error", "digital", "harmful", "dialect",
    ...
    */
    ...
    renderCard(startTime) {
        if (this.state.timer > startTime) {
            return (
                <BingoFadeView style={{ height: "100%", width: "100%", fontSize: 76, alignItems: "center", justifyContent: "center", }}
                    startTime={startTime}
                >
    ...
    */
    ...
    resetVars() {
        ...
        this.setState({
            ...
            randPromptCount: 17, bingoCardLen: null,
